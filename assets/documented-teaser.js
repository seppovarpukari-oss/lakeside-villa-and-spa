...
(function(){
  ...
  const copy={
    ...
    da:{ey:'VILLAEN, DOKUMENTERET',h:'Spørg villaen.',p:'Villaens systemer, historie og driftsviden er samlet i ét intelligent ejendomsregister — klar til at give svar, når der er brug for dem.',c:'UDFORSK DEN DOKUMENTEREDE VILLA →',folder:'da'},
